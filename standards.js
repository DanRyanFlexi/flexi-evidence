// ACARA V9 Achievement Standards — Reception to Year 10
...
const STD = {
  English: {
    'Reception':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
      ...
      {code:'AC9EFW1',strand:'Writing & Creating',text:'Create short written texts, including retelling stories using words and images where appropriate.'},
    ...
    'Year 1':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
      ...
      {code:'AC9E1S2',strand:'Speaking & Listening',text:'Demonstrate understanding of how text structures are used to organise information. Use language features including words, phrases and simple sentences.'},
    ...
    'Year 2':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
    ...
    'Year 3':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
    ...
    'Year 4':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
    ...
    'Year 5':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
    ...
    'Year 6':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
    ...
    'Year 7':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
    ...
    'Year 8':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
    ...
    'Year 9':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
    ...
    'Year 10':{strands:['Speaking & Listening','Reading & Viewing','Writing & Creating'],standards:[
  ...
  Mathematics: {
    'Reception':{strands:['Number','Algebra','Measurement','Space','Statistics'],standards:[
    ...
    'Year 1':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
    ...
    'Year 2':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
    ...
    'Year 3':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
    ...
    'Year 4':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
    ...
    'Year 5':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
    ...
    'Year 6':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
      ...
      {code:'AC9M6N3',strand:'Number',text:'Multiply and divide decimals by powers of 10. Add and subtract decimals and use estimation and rounding to check the reasonableness of answers.'},
      ...
      {code:'AC9M6P1',strand:'Probability',text:'Describe probabilities using fractions, decimals and percentages. Conduct chance experiments with both small and large numbers of trials.'},
    ]},
    'Year 7':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
    ...
    'Year 8':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
      ...
      {code:'AC9M8N2',strand:'Number',text:'Solve problems involving the 4 operations with integers and positive rational numbers, using mathematical modelling to solve practical problems involving ratios, percentages and rates.'},
      ...
      {code:'AC9M8M2',strand:'Measurement',text:'Use Pythagoras\' theorem to solve measurement problems involving unknown lengths of right-angle triangles, and use formulas for area and circumference of circles.'},
    ...
    'Year 9':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
    ...
    'Year 10':{strands:['Number','Algebra','Measurement','Space','Statistics','Probability'],standards:[
